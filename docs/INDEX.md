...
> This directory describes the earlier Gemini-based upstream project. For the
> current GPT Image 2 Polza MCP server, use the root [README](../README.md).
...
| Template Catalog | `gpt-image-2://prompt-templates` | Prompt template browser |
| Operation Status | `gpt-image-2://operations` | Server operation status |
