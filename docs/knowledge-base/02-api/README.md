...
File: `gpt_image_2_polza_mcp_server/tools/generate_image.py`
...
### `upload_file`
File: `gpt_image_2_polza_mcp_server/tools/upload_file.py`
...
### `output_stats`
File: `gpt_image_2_polza_mcp_server/tools/output_stats.py`
...
### `maintenance`
File: `gpt_image_2_polza_mcp_server/tools/maintenance.py`
...
Organized by category in `gpt_image_2_polza_mcp_server/prompts/`:
