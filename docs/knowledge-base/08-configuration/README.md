...
|----------|-------------|---------|
| `GPT_IMAGE_AUTH_METHOD` | `auto` \| `api_key` \| `vertex_ai` | `auto` |
...
File: `gpt_image_2_polza_mcp_server/config/settings.py`
...
| `Gemini31ImageConfig` | NB2 model: extends `ProImageConfig`, overrides model name + timeout, `supports_thinking=True`, `supports_extreme_aspect_ratios=True` |
