#!/usr/bin/env python3
"""GPT Image 2 Polza MCP Server - Main Entry Point."""

import sys
import os
from .config.settings import ServerConfig, GeminiConfig
from .core.server import GptImage2MCP
...
def create_app():
    ...
    logger.info("Initializing GPT Image 2 Polza MCP Server...")
    ...
    try:
        ...
        app = GptImage2MCP(server_config)
...
def create_wrapper_app() -> GptImage2MCP:
...
def main():
    ...
    try:
        logger.info("Starting GPT Image 2 Polza MCP Server...")
