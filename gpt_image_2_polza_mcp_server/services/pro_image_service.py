...
class ProImageService:
    ...
    def __init__(
        ...
        if model_name == "gemini-3.1-flash-image-preview":
            self._tier_label = "nb2"
        elif model_name == "openai/gpt-5.4-image-2":
            self._tier_label = "gpt-image-2"
        else:
            self._tier_label = "pro"
        self._uses_synthid = model_name.startswith("gemini-")
                ...
                try:
                    ...
                    for j, image_bytes in enumerate(images):
                        ...
                        metadata = {
                            ...
                            "synthid_watermark": self._uses_synthid,
                            "prompt": prompt,
