...
def register_generate_image_tool(server: FastMCP):
    ...
    def generate_image(
        ...
        model_tier: Annotated[
            str | None,
            Field(
                description="Model tier. Use 'gpt-image-2' for OpenAI GPT Image 2 "
                "through Polza. This is the default model."
            ),
        ] = "gpt-image-2",
        resolution: Annotated[
            ...
            Field(
                ...
                "GPT Image 2 supports high-resolution output. Default: '1k'."
            ),
        ] = "1k",
        ...
        output_path: Annotated[
            ...
            Field(
                ...
                "If None, uses IMAGE_OUTPUT_DIR environment variable or ~/gpt-image-2-images."
            ),
        ] = None,
        ...
        try:
            ...
            if detected_mode == "edit":
                ...
                elif selected_tier == ModelTier.GPT_IMAGE_2:
                    # Use GPT Image 2 service (OpenAI via Polza, no grounding/thinking)
                    logger.info(f"Using GPT Image 2 model: {model_info['model_id']}")
                    thumbnail_images, metadata = selected_service.generate_images(
                        prompt=prompt,
                        n=n,
                        resolution=resolution,
