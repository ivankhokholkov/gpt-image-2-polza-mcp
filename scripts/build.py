#!/usr/bin/env python3
"""
Build script for GPT Image 2 Polza MCP Server.
...
def verify_package_config(root_dir: Path) -> None:
    ...
    required_files = [
        ...
        ("gpt_image_2_polza_mcp_server/__init__.py", "Package init"),
        ("gpt_image_2_polza_mcp_server/server.py", "Main server module"),
    ]
...
def main():
    ...
    print(f"📦 Building GPT Image 2 Polza MCP Server from {root_dir}")
    print("=" * 60)
